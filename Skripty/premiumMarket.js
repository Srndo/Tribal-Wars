...
function compare(stock, value, string, not_printed, selector) {
...
var check = function(){
	not_printed = compare(wood, 300, "Wood:", not_printed, 9);
	not_printed = compare(clay, 300, "Clay:", not_printed, 12);
	not_printed = compare(iron, 300, "Iron:", not_printed, 15);

	var fader = document.getElementById("fader");
	
	if(fader != null && fader.style.display == "none" )
	{
		not_printed = true;
	}
